...
if ($_SERVER['SERVER_NAME'] == 'localhost') {
	$config['base_url']			= 'http://localhost'.$PortAddress.'/dealer/trunk';
	$config['base_path']		= realpath(dirname(__FILE__) . '/../..');
} else if ($_SERVER['SERVER_NAME'] == 'bengkel.suekarea.com') {
	$config['base_url']			= 'http://bengkel.suekarea.com';
	$config['base_path']		= realpath(dirname(__FILE__) . '/../..');
} else {
...
$config['subclass_prefix'] = 'DEALER_';
