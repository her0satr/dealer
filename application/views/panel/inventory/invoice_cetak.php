...
<div>
	...
	<div style="float: left; width: 250px; font-size: 30px; padding: 8px 0 0 0;">KWINTANSI</div>
	<div style="float: left; width: 250px; font-size: 16px; padding: 16px 0 0 0;">No. <?php echo $invoice['no']; ?></div>
	<div style="clear: both;"></div>
</div>

<div style="padding: 20px 0;">
	<div style="float: left; width: 190px;">Telah Diterima dari</div>
	<div style="float: left; width: 500px;">: <?php echo $invoice['pengantar']; ?></div>
	<div style="clear: both; margin: 0 0 10px 0;"></div>
	<div style="float: left; width: 190px;">Uang Sebesar</div>
	<div style="float: left; width: 500px;">: <?php echo $invoice['rupiah_text']; ?></div>
	<div style="clear: both; margin: 0 0 10px 0;"></div>
	<div style="float: left; width: 190px;">Untuk Pembayaran</div>
	<div style="float: left; width: 500px;">: <?php echo $invoice['content']; ?></div>
	<div style="clear: both; margin: 0 0 10px 0;"></div>
	<div style="padding: 0 0 0 60%;"><?php echo GetFormatDate($invoice['date_print'], array( 'FormatDate' => 'l, j F Y', 'replace_indo' => true )); ?></div>
</div>

<div>
	<div style="float: left; width: 30%;">
		<div style="padding: 0 0 0 25px;">Rp. <?php echo $invoice['rupiah_angka']; ?></div>
	</div>
	<div style="float: left; width: 30%;">
